...
class CartItemAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).select_related("cart", "product", "variant__product", "variant__color", "variant__size")
...
class PaymentRecordAdmin(admin.ModelAdmin):
    list_display = ['stripe_session_id', 'status', 'amount_total', 'currency', 'customer_email', 'receipt_sent_at', 'created_at']
    list_filter = ['status', 'currency', 'created_at']
    search_fields = ['stripe_session_id', 'customer_email']
    readonly_fields = ['stripe_session_id', 'created_at', 'updated_at', 'receipt_sent_at', 'receipt_error']


@admin.register(SaleItem)
class SaleItemAdmin(admin.ModelAdmin):
    list_display = ['product_name', 'quantity', 'unit_price', 'payment']
    search_fields = ['product_name', 'payment__stripe_session_id']
